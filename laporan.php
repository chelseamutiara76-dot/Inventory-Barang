            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    <a
                        ...
                        <img
                            src="assets/img/Bahlil adidas.jpg"
                            alt="Profile"
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="text-muted">Menampilkan Seluruh Stok barang Saat Ini</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fw-bold text-primary">Total Item: <?= $total_item; ?></span>
                                <a href="laporan_stock.php" class="btn btn-sm btn-primary" target="_blank">
                                    Lihat Laporan
                                </a>
                            </div>
                        </div>
